...
# Configuration
DESKTOP_PROJECT="RegistrationEasy/RegistrationEasy.Desktop.csproj"
...
APP_ID="com.registrationeasy.app"
...
if [ -n "$1" ]; then
    ...
    echo -e "${BLUE}==========================================${NC}"
    echo -e "${BLUE}   RegistrationEasy Build Manager         ${NC}"
    echo -e "${BLUE}==========================================${NC}"
    echo "Please select an option:"
    echo "1) Run Desktop Version (Windows)"
